...
export default function IndexPage() {
  useEffect(() => {
    ...
    script.type = "module";
    script.src =
      "https://unpkg.com/@splinetool/viewer@1.9.76/build/spline-viewer.js";
  ...
  return (
    <DefaultLayout>
      ...
      {/* Background Iframe with Spline */}
      {/* Background Spline Viewer */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
        <spline-viewer
          url="https://prod.spline.design/6FvHj30hveMkrNtg/scene.splinecode"
      ...
      <section className="relative flex flex-col items-center justify-center gap-4 py-8 md:py-10 text-white">
        <div className="inline-block max-w-lg text-center justify-center">
          ...
          <div className={subtitle({ class: "mt-4" })}>
            Experience real-time emotion recognition using cutting-edge AI
            technology.
          </div>
        </div>
